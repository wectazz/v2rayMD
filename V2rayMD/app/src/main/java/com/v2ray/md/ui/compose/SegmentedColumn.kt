// Origin: ResukiSu project settings components (GPL), adapted for v2rayMD:
// Koin/ThemeConfig blur branches removed (no DI in this app), package moved.
// Groups items with animated corner morphing, visibility transitions and
// expandable sections; per-item Shape is provided to content and via
// LocalSegmentedItemShape.
            ...
            content = {
                allItems.forEachIndexed { index, itemData ->
                    key(itemData.key ?: index) {
                        ...
                        val forceFlatTop = itemData.forceFlatTop
                        val forceFlatBottom = itemData.forceFlatBottom
